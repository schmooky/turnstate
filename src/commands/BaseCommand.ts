import type { Command, CommandResult, SerializedCommand, ValidationResult } from "../types/api";
...
export abstract class BaseCommand<TState> implements Command<TState> {
  ...
  constructor(params: { playerId: string; type: string; timestamp?: Date; id?: string }) {
